...
const DORAHACKS_URL = 'https://dorahacks.io/hackathon/creativeminds/details';

export default function Footer() {
  return (
    <footer className="relative bg-[#0b0b0e] text-white pt-28 pb-14 px-6 overflow-hidden">
      
      {/* Diagonal Subtle Light Ray Effect (Exact Hanzo Image 5) */}
      ...
      <div className="mx-auto max-w-5xl relative z-10 text-center">
        ...
        {/* Subtitle with Accent Lines (Exact Hanzo style) */}
        ...
        {/* Giant Heading (Exact Hanzo style) */}
        ...
        <div className="pt-10 border-t border-neutral-800/80 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-neutral-400">
          ...
          {/* Copyright Pill */}
          <div className="px-4 py-2 rounded-full border border-neutral-800 bg-neutral-900/60 font-mono">
            © Half-Life, 2026
          </div>

          {/* Center Info */}
          <div className="font-mono text-neutral-500">
            Minds by Animoca Brands · Audience Growth Track
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              title="DoraHacks Hackathon"
              className="w-10 h-10 rounded-full border border-neutral-800 bg-neutral-900/80 hover:bg-neutral-800 hover:text-white flex items-center justify-center transition-colors font-mono text-xs font-bold"
            >
              DH
            </a>
            ...
            <a
              href="https://hanzo.framer.website/"
              target="_blank"
              rel="noreferrer"
              title="Design Reference"
              className="w-10 h-10 rounded-full border border-neutral-800 bg-neutral-900/80 hover:bg-neutral-800 hover:text-white flex items-center justify-center transition-colors font-serif italic text-sm"
            >
              H
            </a>
          </div>
