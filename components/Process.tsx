export default function Process() {
  return (
    <section id="how-it-works" className="relative px-6 py-24 md:py-36 overflow-hidden">
      <div className="mx-auto max-w-6xl">
        
        {/* Section Header (Exact Hanzo style from Image 3) */}
        ...
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-medium text-neutral-900 tracking-[-0.03em] text-center mb-16 sm:mb-24">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 items-center">
          ...
          {/* Card 1 (Tilted Left) */}
          <div className="relative rounded-[2rem] bg-white p-8 sm:p-10 shadow-[0_16px_40px_rgba(0,0,0,0.06)] border border-black/[0.04] md:-rotate-2 hover:rotate-0 transition-transform duration-300 z-10">
          ...
          {/* Card 2 (Tilted Right) */}
          <div className="relative rounded-[2rem] bg-white p-8 sm:p-10 shadow-[0_16px_40px_rgba(0,0,0,0.06)] border border-black/[0.04] md:rotate-2 hover:rotate-0 transition-transform duration-300 z-10 md:translate-y-4">
            <span className="text-6xl sm:text-7xl font-light text-neutral-900 tracking-tight block mb-12 sm:mb-16">
              2
            </span>
            <h3 className="text-xl sm:text-2xl font-semibold text-neutral-900 tracking-tight mb-2">
          ...
          {/* Card 3 (Slightly Tilted Right) */}
          <div className="relative rounded-[2rem] bg-white p-8 sm:p-10 shadow-[0_16px_40px_rgba(0,0,0,0.06)] border border-black/[0.04] md:rotate-1 hover:rotate-0 transition-transform duration-300 z-10">
            <span className="text-6xl sm:text-7xl font-light text-neutral-900 tracking-tight block mb-12 sm:mb-16">
              3
            </span>
            <h3 className="text-xl sm:text-2xl font-semibold text-neutral-900 tracking-tight mb-2">
