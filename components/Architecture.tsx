export default function Architecture() {
  const guarantees = [
    {
      ...
      avatar: '/images/half-life-logo.jpg',
  ...
  return (
    <section id="architecture" className="relative px-6 py-24 md:py-36 overflow-hidden bg-[#f0eff5]">
      <div className="mx-auto max-w-6xl">
        ...
        {/* 3 Guarantee Cards matching Hanzo Testimonial Grid with Double Containers */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {guarantees.map(g => (
            <div
              key={g.id}
              className="group p-[10px] rounded-[2.5rem] bg-white/60 backdrop-blur-xl shadow-[0_12px_32px_rgba(0,0,0,0.06)] border border-white hover:-translate-y-2 transition-all duration-300"
            >
              <div className="rounded-[2rem] bg-white p-8 border border-black/[0.04] shadow-sm flex flex-col justify-between h-full">
                <div>
